...
function all_field() {
  let n = document.forms["fname"]["name"].value;
  let e = document.forms["fname"]["email"].value;
  let no = document.forms["fname"]["number"].value;
  let p = document.forms["fname"]["password"].value;
  let c = document.forms["fname"]["cpassword"].value;
  if (n == "" && e == "" && no == "" && p == "" && c == "") {
